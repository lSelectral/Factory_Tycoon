...
//    List<BigDouble> logarithmicValues;
//    List<BigDouble> values;
...
//        values = new List<BigDouble>();
//        gameObjectList = new List<GameObject>();
//        logarithmicValues = new List<BigDouble>();
//        axisNames = new List<string>();
//        ProductionManager.Instance.scriptableProductionUnitList.
//            ForEach(q => { if (q.ageBelongsTo == Age._0_StoneAge) 
//                { values.Add(q.pricePerProduct); 
//                    logarithmicValues.Add(Mathf.Log10(q.pricePerProduct)); 
//                    axisNames.Add(q.TranslatedName); } });
...
//    private void ShowGraph(List<BigDouble> valueList, IGraphVisual graphVisual, int maxVisibleValueAmount = -1, Func<int, string> getAxisLabelX = null, Func<double, string> getAxisLabelY = null)
//    {
...
//        BigDouble yMaximum = valueList[0];
//        BigDouble yMinimum = valueList[0];

//        for (int i = Mathf.Max(valueList.Count - maxVisibleValueAmount, 0); i < valueList.Count; i++)
//        {
//            BigDouble value = valueList[i];
//            if (value > yMaximum)
//            {
//                yMaximum = value;
//            }
...
//        BigDouble yDifference = yMaximum - yMinimum;
//        if (yDifference <= 0)
//        {
//            yDifference = 5f;
//        }
...
//            BigDouble yPosition = ((valueList[i] - yMinimum) / (yMaximum - yMinimum)) * graphHeight;
...
//        public BarChartVisual(RectTransform graphContainer, RectTransform verticalBarText, List<BigDouble> values, Color barColor, float barWidthMultiplier)
//        {
